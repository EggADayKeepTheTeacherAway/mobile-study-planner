...
import org.classapp.studyplanner.databinding.ItemHomeTaskBinding
import java.time.LocalDate
import java.time.format.TextStyle
import java.util.Locale

class HomeTaskAdapter : ListAdapter<AssignmentWithCourse, HomeTaskAdapter.ViewHolder>(DiffCallback) {

    class ViewHolder(val binding: ItemHomeTaskBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.viewPriorityBar.setBackgroundColor(priorityColor)
